...
function App() {
  ...
  useEffect(() => {
    ...
    //       Cookie:
    //         "_did-603548799=08c09554-c053-4c8f-b905-ffb653761f27; tool=; selection=; portalApp=student; JSESSIONID=1F36F40147D9F7D57FD5087600F3766D; XSRF-TOKEN=f7d33136-ed2b-4f0e-9965-a499b78efd2b; portalLang=en; appName=fremont; sis-cookie=!OG/XePjRHWhUK4nSf/2u9QgDYPqI3C/lxNm9visTZ/XPHgxkfALcy7L2H5CxRU02ZozPzKS1eaDmrVM=",
    //     },
    //   }
    // )
    //   .then((res) => res.json())
    ...
    if (groups.length > 0) {
      for (var i = 0; i < groups.length; i++) {
        ...
        for (var z = 0; z < asgn.length; z++) {
          ...
          // console.log(asgn[z].assignmentName + " " + asgn[z].score);
